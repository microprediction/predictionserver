...
# microserver implementation notes 

You are better off reading the following:

- microserver/serverhabits   Enumerates private redis key naming, and other private implementation details

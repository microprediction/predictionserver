...
class AttributeReader(BaseReader):
    ...
    def get_attribute(self, attribute_type: AttributeType, granularity: Union[AttributeGranularity, str], **kwargs) -> Union[str, int, float]:
        """
    ...
    def get_owner_repository(self, code: str) -> str:
        new_repo = self.get_attribute(attribute_type=AttributeType.repository, granularity=AttributeGranularity.code, code=code)
    ...
    def get_stream_description(self, name: str) -> str:
        return self.get_attribute(attribute_type=AttributeType.description, granularity=AttributeGranularity.name, name=name)

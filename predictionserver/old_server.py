...
from predictionserver.futureconventions.metricconventions import MetricType, MetricGranularity, MetricConventions
...
class MicroRedisClient(AttributeConventions):

    def __init__(self, **kwargs):
        # Send parameters down to microconventions
